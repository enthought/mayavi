...
def flip_normals(stl_fname):
    ...
    normals = mlab.quiver3d(centroids_x, centroids_y, centroids_z, u, v, w, figure=fig)
    centroids = mlab.points3d(
        centroids_x, centroids_y, centroids_z, color=(0.2, 0.6, 0.1), resolution=15
    )
    ...
    outline.bounds = (
        centroids_x[0] - outline_size,
        centroids_x[0] + outline_size,
        centroids_y[0] - outline_size,
        centroids_y[0] + outline_size,
        centroids_z[0] - outline_size,
        centroids_z[0] + outline_size,
    )
    ...
    def picker_callback(picker):
        if picker.actor in centroids.actor.actors:
            ...
            if centroid_id != -1:
                x, y, z = (
                    centroids_x[centroid_id],
                    centroids_y[centroid_id],
