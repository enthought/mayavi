...
from traits.api import HasTraits, Instance, Array, Bool, Dict, on_trait_change
...
class VolumeSlicer(HasTraits):
    ...
    def _data_src_default(self):
        return mlab.pipeline.scalar_field(
            self.data, figure=self.scene3d.mayavi_scene, name="Data",
        )
    ...
    def display_scene3d(self):
        outline = mlab.pipeline.outline(
            self.data_src, figure=self.scene3d.mayavi_scene,
        )
