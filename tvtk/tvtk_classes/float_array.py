...
class FloatArray(DataArray):
    ...
    def get_tuple_value(self, *args):
        ...
        C++: void GetTupleValue(IdType i, float *tuple)
    ...
    def set_tuple_value(self, *args):
        ...
        C++: void SetTupleValue(IdType i, const float *tuple)
    ...
    def insert_next_tuple_value(self, *args):
        ...
        C++: IdType InsertNextTupleValue(const float *tuple)
    ...
    def insert_tuple_value(self, *args):
        ...
        C++: void InsertTupleValue(IdType i, const float *tuple)
