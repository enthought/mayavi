...
class NetworkHierarchy(TreeAlgorithm):
    """
    NetworkHierarchy - Filter that takes a graph and makes a
    ...
    ip_array_name = traits.String(r"ip", enter_set=True, auto_set=False, help=\
        """
    ...
    _updateable_traits_ = \
    (('ip_array_name', 'GetIPArrayName'), ('global_warning_display',
