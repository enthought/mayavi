...
class ReebGraphSimplificationFilter(DirectedGraphAlgorithm):
    ...
    simplification_threshold = traits.Float(0.0, enter_set=True, auto_set=False, help=\
        """
    ...
    ('progress', 'GetProgress'), ('simplification_threshold',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            traitsui.View(([], [], ['simplification_threshold']),
            title='Edit ReebGraphSimplificationFilter properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
