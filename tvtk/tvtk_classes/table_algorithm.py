...
class TableAlgorithm(Algorithm):
    ...
    separate functions such as execute_data and execute_information.  For
    new algorithms you should implement request_data( request, input_vec,
    output_vec) but for older filters there is a default implementation
    that calls the old execute_data(output) signature. For even older
    filters that don't implement execute_data the default implementation
