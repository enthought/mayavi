...
class RectilinearGridSource(Source):
    """
    RectilinearGridSource - Abstract class whose subclasses generates
    rectilinear grid data
    
    Superclass: Source
    
    RectilinearGridSource is an abstract class whose subclasses
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkRectilinearGridSource, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(RectilinearGridSource, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            traitsui.View((traitsui.Item("handler._full_traits_list",show_label=False)),
            title='Edit RectilinearGridSource properties', scrollable=True, resizable=True,
