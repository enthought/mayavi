...
class Community2DLayoutStrategy(GraphLayoutStrategy):
    """
    Community2DLayoutStrategy - a simple fast 2d graph layout
    ...
    community_array_name = traits.String(r"community", enter_set=True, auto_set=False, help=\
        """
    ...
    ('community_array_name', 'GetCommunityArrayName'),
    ...
    ('community_strength', 'GetCommunityStrength'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            traitsui.View(([], [], ['community_array_name', 'community_strength',
