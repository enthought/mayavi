...
class Constrained2DLayoutStrategy(GraphLayoutStrategy):
    """
    Constrained2DLayoutStrategy - a simple fast 2d graph layout
    ...
    input_array_name = traits.String(r"constraint", enter_set=True, auto_set=False, help=\
        """
    ...
    'GetInputArrayName'), ('max_number_of_iterations',
    'GetMaxNumberOfIterations'), ('reference_count', 'GetReferenceCount'),
    ('rest_distance', 'GetRestDistance'), ('weight_edges',
    'GetWeightEdges'))
