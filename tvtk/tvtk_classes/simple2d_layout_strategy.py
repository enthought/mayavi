...
class Simple2DLayoutStrategy(GraphLayoutStrategy):
    ...
    initial_temperature = traits.Trait(1.0, traits.Range(0.0, 9.9999996802856925e+37, enter_set=True, auto_set=False), help=\
        """
    ...
    'GetRestDistance'), ('jitter', 'GetJitter'), ('weight_edges',
    'GetWeightEdges'))
