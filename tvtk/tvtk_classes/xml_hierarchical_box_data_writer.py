...
class XMLHierarchicalBoxDataWriter(XMLCompositeDataWriter):
    """
    XMLHierarchicalBoxDataWriter - writer for
    
    Superclass: XMLCompositeDataWriter
    
    XMLHierarchicalBoxDataWriter is a XMLCompositeDataWriter
    subclass to handle HierarchicalBoxDataSet.
