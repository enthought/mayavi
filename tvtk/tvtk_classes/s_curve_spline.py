...
class SCurveSpline(Spline):
    """
    SCurveSpline - computes an interpolating spline using a
    ...
    ('node_weight', 'GetNodeWeight'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('closed', 'GetClosed'),
    ('reference_count', 'GetReferenceCount'), ('right_constraint',
    'GetRightConstraint'), ('left_value', 'GetLeftValue'),
    ('left_constraint', 'GetLeftConstraint'), ('right_value',
    'GetRightValue'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            'left_value', 'node_weight', 'right_constraint', 'right_value']),
            title='Edit SCurveSpline properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
