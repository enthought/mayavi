...
class ImageIslandRemoval2D(ImageAlgorithm):
    ...
    _updateable_traits_ = \
    (('area_threshold', 'GetAreaThreshold'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('island_value', 'GetIslandValue'),
    ('square_neighborhood', 'GetSquareNeighborhood'), ('progress_text',
    'GetProgressText'), ('debug', 'GetDebug'), ('replace_value',
    'GetReplaceValue'), ('release_data_flag', 'GetReleaseDataFlag'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            traitsui.View((['square_neighborhood'], [], ['area_threshold',
            'island_value', 'replace_value']),
            title='Edit ImageIslandRemoval2D properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
