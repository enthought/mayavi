...
class MultiBlockPLOT3DReader(MultiBlockDataSetAlgorithm):
    ...
    solutions of computational fluid dynamics. Please see the "_plot3d User's
    ...
    ('global_warning_display', 'GetGlobalWarningDisplay'), ('q_file_name',
    'GetQFileName'), ('multi_grid', 'GetMultiGrid'), ('xyz_file_name',
    'GetXYZFileName'), ('uvinf', 'GetUvinf'), ('progress_text',
    'GetProgressText'), ('r', 'GetR'), ('release_data_flag',
    ...
    (['abort_execute', 'binary_file', 'debug', 'force_read',
    'global_warning_display', 'has_byte_count', 'i_blanking',
    'multi_grid', 'release_data_flag', 'two_dimensional_geometry',
    'byte_order', 'file_name', 'gamma', 'progress_text', 'q_file_name',
    'r', 'scalar_function_number', 'uvinf', 'vector_function_number',
    'vvinf', 'wvinf', 'xyz_file_name'])
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            traitsui.View((['binary_file', 'force_read', 'has_byte_count',
            'i_blanking', 'multi_grid', 'two_dimensional_geometry'],
            ['byte_order'], ['file_name', 'gamma', 'q_file_name', 'r',
