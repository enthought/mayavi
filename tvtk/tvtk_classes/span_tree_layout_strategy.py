...
class SpanTreeLayoutStrategy(GraphLayoutStrategy):
    """
    SpanTreeLayoutStrategy
    
    Superclass: GraphLayoutStrategy
    
    SpanTreeLayout is a strategy for drawing directed graphs that
    ...
    ('depth_first_spanning_tree', 'GetDepthFirstSpanningTree'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            traitsui.View((['depth_first_spanning_tree'], [],
            ['edge_weight_field', 'weight_edges']),
            title='Edit SpanTreeLayoutStrategy properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
