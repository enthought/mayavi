...
class PointSetAlgorithm(Algorithm):
    ...
    request_data_object request_data and execute_information. The default
    ...
    def set_input(self, *args):
        ...
        V.set_input(PointSet)
        C++: void SetInput(PointSet *)
        V.set_input(int, PointSet)
        C++: void SetInput(int, PointSet *)
    ...
    def add_input(self, *args):
        ...
        V.add_input(PointSet)
        C++: void AddInput(PointSet *)
        V.add_input(int, PointSet)
        C++: void AddInput(int, PointSet *)
