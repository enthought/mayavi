...
class CharArray(DataArray):
    ...
    def insert_next_tuple_value(self, *args):
        """
        V.insert_next_tuple_value((char, ...)) -> int
        C++: IdType InsertNextTupleValue(const char *tuple)
    ...
    def insert_tuple_value(self, *args):
        """
        V.insert_tuple_value(int, (char, ...))
        C++: void InsertTupleValue(IdType i, const char *tuple)
    ...
    def set_array(self, *args):
        """
        V.set_array(string, int, int)
        C++: void SetArray(char *array, IdType size, int save)
        V.set_array(string, int, int, int)
        C++: void SetArray(char *array, IdType size, int save,
            int deleteMethod)
