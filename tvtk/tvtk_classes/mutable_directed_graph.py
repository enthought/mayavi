...
class MutableDirectedGraph(DirectedGraph):
    ...
    def lazy_add_edge(self, *args):
        ...
        parameterproperty_arr must match up with the arrays in the edge
        data retrieved by get_edge_data().
    ...
    def set_number_of_vertices(self, *args):
        ...
        distributed_graph_helper will generate an error message and no
