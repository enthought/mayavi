...
class IdTypeArray(DataArray):
    ...
    def get_value_range(self, *args):
        """
        V.get_value_range([int, int], int)
        C++: void GetValueRange(IdType range[2], int comp)
        V.get_value_range([int, int])
        C++: void GetValueRange(IdType range[2])
    ...
    def insert_next_tuple_value(self, *args):
        """
        V.insert_next_tuple_value((int, ...)) -> int
        C++: IdType InsertNextTupleValue(const IdType *tuple)
    ...
    def insert_tuple_value(self, *args):
        """
        V.insert_tuple_value(int, (int, ...))
        C++: void InsertTupleValue(IdType i, const IdType *tuple)
