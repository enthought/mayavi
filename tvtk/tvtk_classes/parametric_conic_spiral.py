...
class ParametricConicSpiral(ParametricFunction):
    ...
    _updateable_traits_ = \
    (('a', 'GetA'), ('c', 'GetC'), ('b', 'GetB'),
    ('global_warning_display', 'GetGlobalWarningDisplay'), ('debug',
    'GetDebug'), ('derivatives_available', 'GetDerivativesAvailable'),
    ('join_v', 'GetJoinV'), ('join_u', 'GetJoinU'), ('n', 'GetN'),
    ('twist_v', 'GetTwistV'), ('twist_u', 'GetTwistU'),
    ('clockwise_ordering', 'GetClockwiseOrdering'), ('minimum_u',
    ...
    'a', 'b', 'c', 'maximum_u', 'maximum_v', 'maximum_w', 'minimum_u',
    'minimum_v', 'minimum_w', 'n'])
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            'join_u', 'join_v', 'twist_u', 'twist_v'], [], ['a', 'b', 'c',
