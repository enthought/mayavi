...
class SplitColumnComponents(TableAlgorithm):
    ...
    calculate_magnitudes = traits.Bool(True, help=\
        """
    ...
    ('abort_execute', 'GetAbortExecute'), ('calculate_magnitudes',
    'GetCalculateMagnitudes'), ('release_data_flag',
    'GetReleaseDataFlag'), ('reference_count', 'GetReferenceCount'),
    ('progress', 'GetProgress'))
    
    _full_traitnames_list_ = \
    (['abort_execute', 'debug', 'global_warning_display',
    'release_data_flag', 'calculate_magnitudes', 'progress_text'])
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            traitsui.View(([], [], ['calculate_magnitudes']),
            title='Edit SplitColumnComponents properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
