...
class TreeDFSIterator(Object):
    """
    TreeDFSIterator - depth first seedgeh iterator through a Graph
    
    Superclass: Object
    
    TreeDFSIterator performs a depth first seedgeh of a tree.  First,
