...
class StringToImage(Object):
    """
    StringToImage - uses Qt to render the supplied text to an image.
    ...
    scale_to_power_of_two = traits.Bool(False, help=\
        """
    ...
    def render_string(self, *args):
        """
        V.render_string(TextProperty, unicode, ImageData) -> int
        C++: virtual int RenderString(TextProperty *property,
            const UnicodeString &string, ImageData *data)
        V.render_string(TextProperty, string, ImageData) -> int
        C++: virtual int RenderString(TextProperty *property,
            const StdString &string, ImageData *data)
        Given a text property and a string, this function initializes the
        ImageData *data and renders it in a ImageData.
        """
