...
class ContourFilter(PolyDataAlgorithm):
    ...
    ('array_component', 'GetArrayComponent'), ('use_scalar_tree',
    'GetUseScalarTree'), ('progress_text', 'GetProgressText'),
    ('compute_normals', 'GetComputeNormals'), ('compute_scalars',
    'GetComputeScalars'), ('debug', 'GetDebug'), ('abort_execute',
    ...
    'release_data_flag', 'use_scalar_tree', 'array_component',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            'compute_scalars', 'use_scalar_tree'], [], ['array_component',
            'number_of_contours']),
            title='Edit ContourFilter properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
