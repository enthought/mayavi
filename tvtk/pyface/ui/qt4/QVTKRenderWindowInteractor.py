...
class QVTKRenderWindowInteractor(QVTKRWIBaseClass):
    ...
    def mousePressEvent(self, ev):
        ...
        pxr = self._pixel_ratio
        self._Iren.SetEventInformationFlipY(
            int(ev.x() * pxr), int(ev.y() * pxr), ctrl, shift, chr(0), repeat, None
        )
    ...
    def mouseReleaseEvent(self, ev):
        ...
        pxr = self._pixel_ratio
        self._Iren.SetEventInformationFlipY(
            int(ev.x() * pxr), int(ev.y() * pxr), ctrl, shift, chr(0), 0, None
        )
    ...
    def keyPressEvent(self, ev):
        ...
        self._Iren.SetEventInformationFlipY(
            self.__saveX, self.__saveY, ctrl, shift, key, 0, key_sym
        )
