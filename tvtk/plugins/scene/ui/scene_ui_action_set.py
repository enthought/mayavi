...
class SceneUIActionSet(ActionSet):
    ...
    actions = [
        ...
        # Save actions.
        save_scene, save_scene_to_png, save_scene_to_jpeg, save_scene_to_tiff,
        save_scene_to_bmp, save_scene_to_ps, save_scene_to_gl2ps,
        save_scene_to_rib, save_scene_to_oogl, save_scene_to_vrml,
        save_scene_to_obj, save_scene_to_iv, save_scene_to_pov,
        save_scene_to_x3d,
