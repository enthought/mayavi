...
class NewScene(TaskAction):
    ...
    def perform(self, event):
        ...
        task = self.application.get_task("mayavi.task")
        editor = task.window.central_pane.edit(object(), factory=SceneEditor)
