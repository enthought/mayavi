...
class SaveSceneToBMP(SaveSceneToImage):
    ...
    wildcard = "BMP images (*.bmp)|*.bmp|" "All files (*.*)|*.*"
...
class SaveSceneToPS(SaveSceneToImage):
    ...
    save_method = "save_ps"
    wildcard = "PostScript bitmap images (*.ps)|*.ps|" "All files (*.*)|*.*"
