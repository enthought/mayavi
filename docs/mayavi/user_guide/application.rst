...
Mayavi modules can be used to visualize the data as described in the `An
overview of Mayavi`_ section and the `Learning Mayavi by example`_
...
available here in the `Creating data for Mayavi`_ section.
...
Here is a list of the Mayavi Filters.
   ...
   TriangleFilter
          ...
          using the tvtk.TriangleFilter class.  This is useful when you
          have a downstream filter that only processes triangles.
