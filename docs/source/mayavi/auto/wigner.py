...
mlab.outline(surf_cat1, color=(0.7, 0.7, 0.7), extent=cat1_extent)
mlab.axes(
    surf_cat1,
    color=(0.7, 0.7, 0.7),
    extent=cat1_extent,
...
mlab.outline(surf_cat2, color=(0.7, 0.7, 0.7), extent=cat2_extent)
...
mlab.outline(surf_cat3, color=(0.7, 0.7, 0.7), extent=cat3_extent)
