...
from traitsui.api import Item, Group, View, ImageEnumEditor, InstanceEditor, HGroup
    ...
    Group(
        Item(
            ...
            editor=ImageEnumEditor(
                values=lut_mode_list(), cols=_number_of_lut_cols(), path=lut_image_dir
            ),
        ),
        ...
        Item(
            ...
            editor=InstanceEditor(
                label="Edit LUT properties", id="mayavi.core.lut_manager.edit_lut"
            ),
        ),
        Item(
        ...
        Group(
            ...
            Group(Item(name="number_of_labels"), enabled_when="show_scalar_bar==True",),
            Group(
                Item(name="shadow"),
                Item(name="use_default_name"),
                Item(name="data_name", enabled_when="not object.use_default_name"),
                HGroup(
                    Item(
        ...
        Group(
            ...
            Item(name="data_range", enabled_when="not object.use_default_range"),
            show_border=True,
        ),
