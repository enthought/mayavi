...
class TestArraySourceAttributes(unittest.TestCase):
    ...
    def test_add_attribute_works_for_point_data(self):
        ...
        # Then
        self.assertTrue(
            numpy.allclose(src.image_data.point_data.get_array("s2").to_array(), s2)
        )
        self.assertTrue(
            numpy.allclose(src.image_data.point_data.get_array("v1").to_array(), v1)
        )
        self.assertTrue(
            numpy.allclose(src.image_data.point_data.get_array("t1").to_array(), t1)
        )
    ...
    def test_add_attribute_works_for_cell_data(self):
        ...
        # Then
        self.assertTrue(
            numpy.allclose(src.image_data.cell_data.get_array("s2").to_array(), s2)
        )
        self.assertTrue(
            numpy.allclose(src.image_data.cell_data.get_array("v1").to_array(), v1)
        )
        self.assertTrue(
            numpy.allclose(src.image_data.cell_data.get_array("t1").to_array(), t1)
        )
    ...
    def test_remove_attribute(self):
        ...
        self.assertTrue(
            numpy.allclose(
                src.image_data.point_data.get_array("s1").to_array(), s1.ravel()
            )
        )
