...
class TestScriptRecording(unittest.TestCase):
    ...
    def test_script_recording(self):
        ...
        e.add_source(src)
        expect = "from mayavi.sources.parametric_surface " "import ParametricSurface"
        ...
        self.assertEqual(
            tape.lines[-1], "outline.actor.property.color = (1.0, 0.0, 0.0)"
        )
        ...
        self.assertEqual(
            tape.lines[-1], "surface.actor.property.representation = 'wireframe'"
        )

        o.actor.property.representation = "wireframe"
        self.assertEqual(
            tape.lines[-1], "outline.actor.property.representation = 'wireframe'"
        )
        ...
        self.assertEqual(
            tape.lines[-1], "surface.actor.mapper.scalar_visibility = False"
        )
