...
class TestExtractGridFilter(unittest.TestCase):
    ...
    def test_extract_grid_filter_sample(self):
        ...
        self.assertEqual(
            allclose(
                gpx.actor.actor.bounds, (100.0, 100.0, 100.0, 200.0, 100.0, 200.0)
            ),
            True,
        )
        self.assertEqual(
            allclose(
                gpy.actor.actor.bounds, (100.0, 200.0, 100.0, 100.0, 100.0, 200.0)
            ),
            True,
        )
        self.assertEqual(
            allclose(
                gpz.actor.actor.bounds, (100.0, 200.0, 100.0, 200.0, 100.0, 100.0)
            ),
            True,
        )
    ...
    def test_voi(self):
        ...
        self.assertEqual(
            allclose(
                gpx.actor.actor.bounds, (120.0, 120.0, 100.0, 200.0, 100.0, 200.0)
            ),
            True,
        )
        self.assertEqual(
            allclose(
                gpy.actor.actor.bounds, (120.0, 180.0, 100.0, 100.0, 100.0, 200.0)
            ),
            True,
        )
        self.assertEqual(
            allclose(
                gpz.actor.actor.bounds, (120.0, 180.0, 100.0, 200.0, 100.0, 100.0)
            ),
            True,
        )
