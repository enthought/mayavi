...
file_group = Group(id="MayaviFileGroup", path="MenuBar/File", before="ExitGroup")

visualize_group = Group(id="VisualizeGroup", path="MenuBar/VisualizeMenu",)

modules_group = Group(id="ModulesGroup", path="MenuBar/VisualizeMenu/ModulesMenu",)

filters_group = Group(id="FiltersGroup", path="MenuBar/VisualizeMenu/FiltersMenu",)
########################################
# Menus

open_menu = Menu(
    id="LoadDataMenu", name="&Load data", path="MenuBar/File", group="MayaviFileGroup"
)
...
modules_menu = Menu(id="ModulesMenu", name="&Modules", path="MenuBar/VisualizeMenu",)
