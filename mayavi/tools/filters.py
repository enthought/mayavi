...
class SetActiveAttributeFactory(PipeFactory):
    ...
    point_scalars = String(
        adapts="point_scalars_name", help="The name of the active point scalars"
    )

    point_vectors = String(
        adapts="point_vectors_name", help="The name of the active point vectors"
    )

    point_tensors = String(
        adapts="point_tensors_name", help="The name of the active point tensors"
    )
    ...
    def __init__(self, parent, **kwargs):
        if "filter" in kwargs:
            ...
            if not "name" in kwargs:
                kwargs["name"] = "UserDefined(%s)" % kwargs["filter"].__class__.__name__
