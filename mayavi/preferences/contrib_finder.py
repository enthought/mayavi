...
class ContribFinder(HasTraits):
    ...
    found_contrib = List(Str, desc="the mayavi contribution " "packages on the system")

    # Search for contributions.
    search = Button("Search for packages", desc="search again for contributions")
    ...
    view = View(
        Item(
            ...
            editor=SetEditor(
                name="found_contrib",
                left_column_title="Available " "contributions",
                right_column_title="Selected " "contributions",
                can_move_all=False,
            ),
            resizable=True,
        ),
